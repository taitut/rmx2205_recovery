...
TARGET_BOARD_PLATFORM := MT6891               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := RM6891     # From ro.product.board
...
DEVICE_RESOLUTION := 360x800                 # The Resolution of your Device
TARGET_SCREEN_HEIGHT := 800                    # The height
TARGET_SCREEN_WIDTH := 360                      # The width
